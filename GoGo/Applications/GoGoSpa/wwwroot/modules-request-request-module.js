...
var RequestFormComponent = /** @class */ (function (_super) {
    ...
    function RequestFormComponent(route, router, requestService, notificationService, validationService, _notificationService) {
        ...
        _this.formConfiguration.dataSourceMapper.add('CurrentWarehouse', requestService, _this.onAfterGetData);
        _super.prototype.formOnInit.call(_this, "Request", {});
        return _this;
    }
    RequestFormComponent.prototype.onAfterGetData = function (res, formData) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _request_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../request.service */ "./src/app/modules/request/request.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RequestListComponent = /** @class */ (function () {
    ...
    RequestListComponent.prototype.onClickActivate = function () {
        //this._requestService.
    };
    RequestListComponent.prototype.onClickDeactivate = function () {
    };
