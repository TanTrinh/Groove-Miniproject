...
var ShipmentPickingComponent = /** @class */ (function () {
    ...
    ShipmentPickingComponent.prototype.changeStatus = function (item, status) {
        ...
        this.service.changeStatusRequest(param).subscribe(function (data) {
            ...
            if (status == "Completed") {
                _this.refeshShipment(_this.code);
            }
        });
    };
    ShipmentPickingComponent.prototype.nextRequest = function () {
        this.refeshShipment(this.code);
    };
    ShipmentPickingComponent.prototype.sendProblem = function (item, isSolve) {
        var _this = this;
        console.log(item);
        console.log(this.problemMessage);
        var temp;
        var param = { 'requestcode': item.code, 'message': this.problemMessage, 'isSolve': isSolve };
        this.service.sendProblem(param).subscribe(function (data) {
            _this.request = data;
            _this.GetRequestList();
        });
    };
...
var ShipmentService = /** @class */ (function () {
    ...
    ShipmentService.prototype.sendProblem = function (paramerter) {
