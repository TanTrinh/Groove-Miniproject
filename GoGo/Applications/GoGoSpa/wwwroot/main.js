...
var ShipmentCreatingComponent = /** @class */ (function () {
    function ShipmentCreatingComponent(shipmentService, router, http, requestService, masterDataService, sharingService) {
        var _this = this;
        ...
        this.valueNormalizer = function (text) { return text.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(_this.service)); };
        this.service = function (text) { return _this.http.post('normalize/url', { text: text }); };
    ...
    ShipmentCreatingComponent.prototype.ngOnInit = function () {
        ...
        if (this.sharingService.isNewShipment == false) {
            this.shipmentService.GetDetailByCode(this.sharingService.shipmentCode).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (res) { return res.json(); })).subscribe(function (result) {
                ...
                _this.requestList = result.RequestList;
    ...
    ShipmentCreatingComponent.prototype.onSave = function () {
        var _this = this;
    ...
    ShipmentCreatingComponent.prototype.onCancel = function () {
...
var ShipmentListComponent = /** @class */ (function () {
    ...
    ShipmentListComponent.prototype.onCreate = function () {
        this.sharingService.isNewShipment = true;
        this.router.navigate(['/shipment/create']);
    };
    ShipmentListComponent.prototype.onUpdate = function (value) {
...
var ShipmentService = /** @class */ (function (_super) {
    ...
    ShipmentService.prototype.fetch = function (state) {
        ...
        var hasGroups = state.group && state.group.length;
        return this.https
            .get(this.baseUrl + "/shipments/datasource?" + queryStr).pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return ({
            data: response['Data'],
            total: parseInt(response['Total'], 10)
        }); }));
    };
    ShipmentService.prototype.GetDetailByCode = function (Code) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_5__["Headers"]();
        return this.http.get(this.baseUrl + '/shipments/Detail?Code=' + Code, { headers: headers });
    };
