...
var ShipmentPickingComponent = /** @class */ (function () {
    ...
    ShipmentPickingComponent.prototype.sendProblem = function (item) {
        var _this = this;
        console.log(item);
