...
var ShipmentCreatingComponent = /** @class */ (function () {
    ...
    ShipmentCreatingComponent.prototype.onChange = function (Value) {
        var _this = this;
        this.masterDataService.getVehicleDetail(Value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (res) { return res.json(); }))
            .subscribe(function (result) {
            _this.vehicleDetail = result;
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\intern08\Documents\gogogo\GoGo\Applications\GoGoSpa\Client-App\src\main.ts */"./src/main.ts");
