...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(http, router, route, location) {
        this.http = http;
        this.router = router;
        this.route = route;
        this.location = location;
    ...
    UserProfileComponent.prototype.confirm = function (id) {
        ...
        if (this.lStorage != 0) {
            ...
            this.http.put('http://localhost:62772/api/user/edit/profile?id=' + id, this.userProfile, httpOptions).subscribe(function (result) {
                if (result) {
                    _this.data = result;
                    jquery__WEBPACK_IMPORTED_MODULE_6__('#btn-smessage').attr('data-target', '#EditMessage');
                }
            });
        }
    };
